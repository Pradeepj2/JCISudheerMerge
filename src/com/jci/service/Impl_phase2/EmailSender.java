...
public class EmailSender {
	...
	public void sendEmail(InternetAddress[] toAddresses, String body, String subject, String filename,
		...
		/*
		 * String smtpHost = "smtp.office365.com"; int smtpPort = 587; // Use 587 for
		 * TLS or 465 for SSL String username = "jci.erp.ops@jcimail.in"; // Office 365
		 * email address String password = "Jute@1234";
		 */
