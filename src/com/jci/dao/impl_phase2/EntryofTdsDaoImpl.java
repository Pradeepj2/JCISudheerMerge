...
public class EntryofTdsDaoImpl implements EntryofTdsDao{
	...
	/*
	 * @Override public String contractIdentification(String Mill) { // TODO
	 * Auto-generated method stub String
	 * q="SELECT DISTINCT Contract_identification_no FROM jcicontract where Mill_name = '"
	 * +Mill+"'"; String contractIdentication= (String)
	 * this.sessionFactory.getCurrentSession().createSQLQuery(q).uniqueResult();
	 * System.out.println(contractIdentication);
	 * 
	 * return contractIdentication;
	 * 
	...
	/*
	 * @Override public List<Object> contractIdentification(String Mill) { // TODO
	 * Auto-generated method stub //String
	 * q="SELECT DISTINCT Contract_identification_no FROM jcicontract where Mill_name = '"
	 * +Mill+"'"; String q =
	 * "SELECT DISTINCT Mill_name FROM jcicontract WHERE Mill_name = '" + Mill +
	 * "'"; //String
	 * q="SELECT Mill_name , CropYear from jcicontract where Mill_code = '"
	 * +Mill_code+"'" ; //String
	 * q="SELECT DISTINCT mill FROM jcicontract where Mill_name = '"+Mill+"'";
	 * List<Object> contractIdentication= (List<Object>)
	 * this.sessionFactory.getCurrentSession().createSQLQuery(q).uniqueResult();
	 * System.err.println(contractIdentication + "kkkkkkkkkkkkkk");
	 * 
	 * return contractIdentication;
	 * 
	 * }
...
//		@Override
//		public List<Object> contractIdentification(String Mill_code) {
//			// TODO Auto-generated method stub
//			return null;
//		}
