		...
		<ul class="side-menu metismenu">
			...
			<li><a href="javascript:void(0);"><i
				...
				<ul class="nav-2-level ">
					...
					<li data-pre="59" id="o59"><a href="SearchTally.obj"><i
					...
					<li data-pre="" id=""><a href="uploadexcelsheet.obj"><i
			...
			<li><a href="javascript:void(0);"><i
				...
				<ul class="nav-2-level">
					...
					<li data-pre="36" id="o36"><a href="entry_derivativeprice.obj"><i
			...
			<li><a href="javascript:void(0);"><i
				...
				<ul class="nav-2-level">
					...
					<li data-pre="52" id="o52"><a href="dispatch.obj"><i
							class="sidebar-item-icon fa fa-th-large"></i><b>Dispatch Ho</b></a></li>
					<li data-pre="52" id="o52"><a href="jcilist.obj"><i
							class="sidebar-item-icon fa fa-th-large"></i><b>View Dispatch
								Ho</b></a></li>
					<li data-pre="52" id="o52"><a href="millacceptform.obj"><i
							class="sidebar-item-icon fa fa-th-large"></i><b> Mill
								Acceptance Form</b></a></li>


					<li data-pre="52" id="o52"><a href="viewmillaccept.obj"><i
   		...
   		<li data-pre="52" id="o52"><a href="viewentryoftds.obj"><i
							class="sidebar-item-icon fa fa-th-large"></i><b>  View Entry of TDS
								U/s 194Q Declaration </b></a></li>
