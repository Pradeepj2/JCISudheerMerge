								...
								<form action="saveBinDetails.obj" method="POST">
									<div class="row">
										<div class="col-sm-4 form-group">
											<label>DPC Name</label> <input class="form-control"
												name="dpcid" id="dpcid" type="hidden" value="<%=dpcid%>">
											<input class="form-control" name="dpcname" type="text"
												placeholder="Place of Purchase" value="<%=dpcCenter%>"
										...
										<div class="col-sm-4 form-group">
											<label class="required">Bin Number</label> <select
												class="form-control" name="binnumb" id="binno"
												placeholder="Bin" value="" readonly>
												<option disabled selected value>-Select-</option>
											</select>
										</div>
										...
										<div class="col-sm-4 form-group">
											<label>Jute Variety</label> <select name="jutevariety"
												id="jutevariety" class="form-control"
												placeholder="Jute Variety">
												<option value="">-Select-</option>
											</select>
										</div>
									...
									<div class="row">
										...
										<div class="col-sm-4 form-group">
											<label>Date</label> <input class="form-control" name="date"
												id="date" placeholder="dd-mm-yyyy" value="" readonly>
										</div>
									</div>
