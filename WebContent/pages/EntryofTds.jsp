                       ...
                       <form action="saveentryoftds.obj" method="POST" enctype="multipart/form-data">
                                 <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group">
												...
												<input class="form-control textbox" name="DateofIntimation" id="DateofIntimation" type="date">
										</div>
                                   ...
                                   <div class="row">
	                                       ...
	                                       <div class="col-sm-4 form-group">
	                                             ...
	                                             <input class="form-control textbox" name="SupportingDocument" id="SupportingDocument" type="file" placeholder="DI No & Date" required>
	                                       </div>
