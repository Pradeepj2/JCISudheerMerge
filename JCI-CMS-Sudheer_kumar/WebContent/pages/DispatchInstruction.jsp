...
<body class="fixed-navbar" onload="myFunction()">
	...
	<div class="page-wrapper">
                                	...
                                	<div class="col-sm-4 form-group">
										...
										<div class="col-sm-4 form-group" id="dpc_div">
											<label id="dpclabel" class="required">DPC</label> &nbsp;&nbsp;&nbsp;
											  <select class="form-control" id="dpc_div" name="dpc">
       ...
       <div><label>Enter Grade Wise Allocation</label> </div>
        <label for="grade1">Grade 1:</label>
        <input type="text" id="grade1" class="onlydigit" name="grade1" value="0"><br>

        <label for="grade2">Grade 2:</label>
        <input type="text" id="grade2" name="grade2" class="onlydigit" value="0"><br>

        <label for="grade3">Grade 3:</label>
        <input type="text" id="grade3" name="grade3" class="onlydigit" value="0"><br>

        <label for="grade4">Grade 4:</label>
        <input type="text" id="grade4" name="grade4"  class="onlydigit" value="0"><br>

        <label for="grade5">Grade 5:</label>
        <input type="text" id="grade5" name="grade5" class="onlydigit" value="0"><br>

        <label for="grade6">Grade 6:</label>
        <input type="text" id="grade6" name="grade6" class="onlydigit" value="0"><br>

        <label for="grade7">Grade 7:</label>
        <input type="text" id="grade7" name="grade7" class="onlydigit" value="0"><br>

        <label for="grade8">Grade 8:</label>
        <input type="text" id="grade8" name="grade8" class="onlydigit" value="0"><br>
...
<!--    Applying Ajax Call Here  for sending data of Financial Concurrence-->
	...
	$(document).ready(function() {
	  ...
	  alert("This Is My Hello Dispatch Page");
